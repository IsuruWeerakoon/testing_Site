...
<?php
$query = mysqli_query($connect,"select * from students where student_id='$session_id'")or die(mysqli_error());
		...
		<div class="margin-top">
			...
			<?php
						...
						<?php
                            ...
                            mysqli_query($connect,"update students set password = '$np' where student_id = '$session_id' ")or die(mysqli_error()); ?>
